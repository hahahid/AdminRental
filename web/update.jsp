        ...
        <div id="card" align="center"> 
            ...
            <table border="0">
                    ...
                    <tr>
                        ...
                        <td width="200px"><div id="font-form" align="center"><input type="text" name="id_motor" value=""></div></td>
                    </tr>
                    <tr>
                        <td width="150px"><div id="font-form" align="left">Plat Nomor</div></td>
                        <td width="200px"><div id="font-form" align="center"><input type="text" name="plat_motor" value=""></div></td>
                    </tr>
                    <tr>
                        <td width="150px"><div id="font-form" align="left">Merk Motor</div></td>
